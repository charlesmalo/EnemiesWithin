...
public class Parallaxing : MonoBehaviour {
    ...
    public float smoothing=1f;                  //How smooth the parallax is going to be. Make sure it's >0;
	...
	void Start () {
        ...
        {
            parallaxScales[i] = backgrounds[i].position.z * (-1); // the minus 1 is needed so that we dont get the opposite parallax scale... i'm guessing it's related to viewport?
        }
	...
	void Update () {
        ...
        for (int i = 0; i < backgrounds.Length; i++)
        {
            ...
            //set the target x position which is th ecurrent position plus the parallax;
